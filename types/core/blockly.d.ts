...
declare module Blockly {
    ...
    class Block__Class implements Blockly.IASTNodeLocation, Blockly.IDeletable {
        ...
        setOnChange(onchangeFn: {
            (_0: Blockly.Events.Abstract): any /*missing*/;
        }): void;
        ...
        setPreviousStatement(
            newBoolean: boolean,
            opt_check?: string | string[] | any /*null*/
        ): void;
...
declare module Blockly {
    ...
    class BlockDragger__Class implements Blockly.IBlockDragger {
        ...
        getNewLocationAfterDrag_(
            ...
            newLocation: Blockly.utils.Coordinate;
        };
        ...
        pixelsToWorkspaceUnits_(
            pixelCoord: Blockly.utils.Coordinate
...
declare module Blockly {
    ...
    /** Fake class which should be extended to avoid inheriting static properties */
    class BlockSvg__Class
        extends Blockly.Block__Class
        implements
            ...
            Blockly.IDraggable
    {
         ...
         */
        getColourBorder(): {
            colourDark: any /*missing*/;
            colourLight: any /*missing*/;
            colourBorder: any /*missing*/;
        };
        ...
        positionNearConnection(
            sourceConnection: Blockly.RenderedConnection,
...
declare module Blockly {
    ...
    function confirm(
        message: string,
        callback: { (_0: boolean): any /*missing*/ }
    ): void;
    ...
    function prompt(
        message: string,
        defaultValue: string,
        callback: { (_0: string): any /*missing*/ }
    ): void;
...
declare module Blockly {
    ...
    class Bubble__Class implements Blockly.IBubble {
         ...
         */
        moveDuringDrag(
            dragSurface: Blockly.BlockDragSurfaceSvg,
...
declare module Blockly.Bubble {
     ...
     * @package
     */
    function createNonEditableBubble(
        paragraphElement: SVGTextElement,
        block: Blockly.BlockSvg,
        iconXY: Blockly.utils.Coordinate
    ): Blockly.Bubble;
}
...
declare module Blockly {
    ...
    class ComponentManager__Class {
         ...
         */
        addComponent(
            componentInfo: Blockly.ComponentManager.ComponentDatum,
        ...
        addCapability<T>(
            id: string,
            capability: string | Blockly.ComponentManager.Capability<T>
        ): void;
...
declare module Blockly.ComponentManager {
    ...
    interface ComponentDatum {
        ...
        capabilities:
            | string
            | Blockly.ComponentManager.Capability<Blockly.IComponent>[];
        weight: number;
    }
}
...
declare module Blockly.Connection {
     ...
     *     blocks, or null.
     */
    function getConnectionForOrphanedConnection(
...
declare module Blockly {
    ...
    class ConnectionDB__Class {
        ...
        ): { connection: Blockly.RenderedConnection; radius: number };
    }
}
...
declare module Blockly.ContextMenu {
     ...
     * @package
     */
    function commentDuplicateOption(
        comment: Blockly.WorkspaceCommentSvg
    ): Object;
...
declare module Blockly.ContextMenuRegistry {
    ...
    interface RegistryItem {
        ...
        scopeType: Blockly.ContextMenuRegistry.ScopeType;
        displayText:
            | { (_0: Blockly.ContextMenuRegistry.Scope): string }
            | string;
...
declare module Blockly {
    ...
    /** Fake class which should be extended to avoid inheriting static properties */
    class DeleteArea__Class
        extends Blockly.DragTarget__Class
...
declare module Blockly.DropDownDiv {
     ...
     */
    function showPositionedByBlock(
        field: Blockly.Field,
        block: Blockly.BlockSvg,
        opt_onHide?: Function,
     ...
     * @return {boolean} True if the menu rendered below block; false if above.
     */
    function showPositionedByField(
        field: Blockly.Field,
        opt_onHide?: Function,
        opt_secondaryYOffset?: number
    ): boolean;
...
declare module Blockly {
            ...
            Blockly.IRegistrable
    {
         ...
         */
        onShortcut(
            _shortcut: Blockly.ShortcutRegistry.KeyboardShortcut
        ): boolean;
...
declare module Blockly {
    ...
    class FieldImage__Class extends Blockly.Field__Class {
        ...
        constructor(
            ...
            opt_alt?: string,
            opt_onClick?: { (_0: Blockly.FieldImage): any /*missing*/ },
            opt_flipRtl?: boolean,
            opt_config?: Object
        );
        ...
        setOnClickHandler(func: {
            (_0: Blockly.FieldImage): any /*missing*/;
        }): void;
    }
}
...
declare module Blockly {
    ...
    class FieldNumber__Class extends Blockly.FieldTextInput__Class {
        ...
        constructor(
            opt_value?: string | number,
            opt_min?: string | number,
            opt_max?: string | number,
            opt_precision?: string | number,
            opt_validator?: Function,
            opt_config?: Object
        );
         ...
         */
        setConstraints(
            min: number | string | any /*undefined*/,
            max: number | string | any /*undefined*/,
            precision: number | string | any /*undefined*/
        ): void;
...
declare module Blockly {
    ...
    class FieldVariable__Class extends Blockly.FieldDropdown__Class {
        ...
        constructor(
            varName: string,
            opt_validator?: Function,
            opt_variableTypes?: string[],
            opt_defaultType?: string,
            opt_config?: Object
        );
...
declare module Blockly {
    ...
    /** Fake class which should be extended to avoid inheriting static properties */
    class Flyout__Class
        extends Blockly.DeleteArea__Class
...
declare module Blockly {
    ...
    function inject(
        ...
        opt_options?: Blockly.BlocklyOptions
     ...
     * @package
     */
    function bumpObjectIntoBounds_(
        workspace: Blockly.WorkspaceSvg,
        scrollMetrics: Blockly.MetricsManager.ContainerRegion,
        object: Blockly.IBoundedElement
    ): boolean;
}
...
declare module Blockly {
    ...
    class InsertionMarkerManager__Class {
        ...
        update(
            dxy: Blockly.utils.Coordinate,
            dragTarget: Blockly.IDragTarget
        ): void;
...
declare module Blockly {
    ...
    class MenuItem__Class {
         ...
         */
        onAction(
            fn: { (_0: Blockly.MenuItem): any /*missing*/ },
            obj: Object
        ): void;
    }
}
...
declare module Blockly {
    ...
    class MetricsManager__Class implements Blockly.IMetricsManager {
         ...
         */
        getDimensionsPx_(
            elem: Blockly.IToolbox | Blockly.IFlyout
        ): Blockly.utils.Size;
        ...
        getComputedFixedEdges_(
            opt_viewMetrics?: Blockly.MetricsManager.ContainerRegion
        ...
        getScrollMetrics(
            opt_getWorkspaceCoordinates?: boolean,
            opt_viewMetrics?: Blockly.MetricsManager.ContainerRegion,
            opt_contentMetrics?: Blockly.MetricsManager.ContainerRegion
        ): Blockly.MetricsManager.ContainerRegion;
...
declare module Blockly.Mutator {
     ...
     */
    function reconnect(
        connectionChild: Blockly.Connection,
        block: Blockly.Block,
        inputName: string
    ): boolean;
...
declare module Blockly.uiPosition {
     ...
     * @package
     */
    function getCornerOppositeToolbox(
        workspace: Blockly.WorkspaceSvg,
        metrics: Blockly.MetricsManager.UiMetrics
    ...
    function bumpPositionRect(
        ...
        margin: number,
        bumpDirection: Blockly.uiPosition.bumpDirection,
...
declare module Blockly.registry {
    ...
    function register<T>(
        ...
        name: string,
        registryItem: { (_0: any[]): any /*missing*/ } | Object,
        opt_allowOverrides?: boolean
    ): void;
...
declare module Blockly {
    ...
    class ShortcutRegistry__Class {
         ...
         */
        addKeyMapping(
            keyCode: string | Blockly.utils.KeyCodes,
            shortcutName: string,
         ...
         */
        getKeyMap(): {
            [key: string]: Blockly.ShortcutRegistry.KeyboardShortcut[];
        };
...
declare module Blockly.ShortcutRegistry {
    ...
    interface KeyboardShortcut {
        callback:
            | {
                  (
                      _0: Blockly.Workspace,
                      _1: Event,
                      _2: Blockly.ShortcutRegistry.KeyboardShortcut
                  ): boolean;
              }
            | any /*undefined*/;
        name: string;
        preconditionFn:
            | { (_0: Blockly.Workspace): boolean }
            | any /*undefined*/;
...
declare module Blockly {
    ...
    class Theme__Class {
        ...
        constructor(
            name: string,
            opt_blockStyles?: { [key: string]: Blockly.Theme.BlockStyle },
            opt_categoryStyles?: { [key: string]: Blockly.Theme.CategoryStyle },
            opt_componentStyles?: Blockly.Theme.ComponentStyle
        );
...
declare module Blockly.Themes {
    var Synctree: Blockly.Theme;
}
...
declare module Blockly.utils {
     ...
     * @package
     */
    function screenToWsCoordinates(
        ws: Blockly.WorkspaceSvg,
        screenCoordinates: Blockly.utils.Coordinate
    ): Blockly.utils.Coordinate;
     ...
     */
    function parseBlockColour(colour: number | string): {
        hue: number;
        hex: string;
    };
}
...
declare module Blockly.VariableModel {
    ...
    function compareByName(
        var1: Blockly.VariableModel,
        var2: Blockly.VariableModel
    ): number;
}
...
declare module Blockly.Variables {
    ...
    function createVariableButtonHandler(
        workspace: Blockly.Workspace,
        opt_callback?: { (_0: string): any /*missing*/ },
        opt_type?: string
    ): void;
     ...
     * @public
     */
    function generateVariableFieldDom(
        variableModel: Blockly.VariableModel
    ): Element;
    ...
    function getAddedVariables(
        workspace: Blockly.Workspace,
        originalVariables: Blockly.VariableModel[]
    ): Blockly.VariableModel[];
}
...
declare module Blockly.WidgetDiv {
    ...
    function positionWithAnchor(
        viewportBBox: Blockly.utils.Rect,
        anchorBBox: Blockly.utils.Rect,
        widgetSize: Blockly.utils.Size,
        rtl: boolean
    ): void;
}
...
declare module Blockly.WorkspaceComment {
     ...
     * @package
     */
    function parseAttributes(xml: Element): {
        w: number;
        h: number;
        x: number;
        y: number;
...
declare module Blockly {
    ...
    /** Fake class which should be extended to avoid inheriting static properties */
    class WorkspaceCommentSvg__Class
        extends Blockly.WorkspaceComment__Class
        implements Blockly.IBoundedElement, Blockly.IBubble, Blockly.ICopyable
    {
        /**
...
declare module Blockly {
    ...
    /** Fake class which should be extended to avoid inheriting static properties */
    class WorkspaceSvg__Class
        extends Blockly.Workspace__Class
        implements Blockly.IASTNodeLocationSvg
    {
        /**
        ...
        constructor(
            options: Blockly.Options,
            opt_blockDragSurface?: Blockly.BlockDragSurfaceSvg,
            opt_wsDragSurface?: Blockly.WorkspaceDragSurfaceSvg
        );
         ...
         * @public
         */
        getComponentManager(): Blockly.ComponentManager;
         ...
         */
        getDragTarget(e: Event): Blockly.IDragTarget;
         ...
         */
        updateToolbox(
            toolboxDef: Blockly.utils.toolbox.ToolboxDefinition
        ): void;
        ...
        registerButtonCallback(
            key: string,
            func: { (_0: Blockly.FlyoutButton): any /*missing*/ }
        ): void;
        ...
        getButtonCallback(key: string): {
            (_0: Blockly.FlyoutButton): any /*missing*/;
        };
...
declare module Blockly.Events {
     ...
     */
    function filter(
        queueIn: Blockly.Events.Abstract[],
        forward: boolean
...
declare module Blockly.Events {
    ...
    class BubbleOpen__Class extends Blockly.Events.UiBase__Class {
         ...
         */
        constructor(
            opt_block: Blockly.BlockSvg,
            opt_isOpen?: boolean,
            opt_bubbleType?: string
        );
...
declare module Blockly.Events {
    ...
    class MarkerMove__Class extends Blockly.Events.UiBase__Class {
        ...
        constructor(
            opt_block?: Blockly.Block,
            isCursor?: boolean,
            opt_oldNode?: Blockly.ASTNode,
            opt_newNode?: Blockly.ASTNode
        );
...
declare module Blockly.Events {
    ...
    class Selected__Class extends Blockly.Events.UiBase__Class {
         ...
         */
        constructor(
            opt_oldElementId?: string,
            opt_newElementId?: string,
            opt_workspaceId?: string
        );
...
declare module Blockly.Events {
    ...
    class CommentChange__Class extends Blockly.Events.CommentBase__Class {
         ...
         */
        constructor(
            opt_comment?: Blockly.WorkspaceComment,
     ...
     */
    function CommentCreateDeleteHelper(
        event: Blockly.Events.CommentCreate | Blockly.Events.CommentDelete,
        create: boolean
    ): void;
}
...
declare module Blockly {
    interface IAutoHideable extends Blockly.IComponent {
        /**
         * Hides the component. Called in Blockly.hideChaff.
         * @param {boolean} onlyClosePopups Whether only popups should be closed.
         *   Flyouts should not be closed if this is true.
...
declare module Blockly {
    interface IBubble extends Blockly.IDraggable, Blockly.IContextMenu {
        /**
         * Return the coordinates of the top-left corner of this bubble's body relative
         * to the drawing surface's origin (0,0), in workspace units.
         * @return {!Blockly.utils.Coordinate} Object with .x and .y properties.
...
declare module Blockly.IComponent {
    /**
     * The unique id for this component that is used to register with the
     * ComponentManager.
     * @type {string}
...
declare module Blockly {
    interface IDeleteArea extends Blockly.IDragTarget {
        /**
         * Returns whether the provided block or bubble would be deleted if dropped on
         * this area.
         * This method should check if the element is deletable and is always called
...
declare module Blockly {
    interface IDragTarget extends Blockly.IComponent {
        /**
         * Returns the bounding rectangle of the drag target area in pixel units
         * relative to viewport.
         * @return {?Blockly.utils.Rect} The component's bounding box. Null if drag
         ...
         *   dragged.
         */
        onDragOver(dragElement: Blockly.IDraggable): void;
...
declare module Blockly {
    interface IDraggable extends Blockly.IDeletable {}
}
...
declare module Blockly {
    interface IPositionable extends Blockly.IComponent {
        /**
...
declare module Blockly {
    ...
    class ASTNode__Class {
        ...
        constructor(
            type: string,
            location: Blockly.IASTNodeLocation,
            opt_params?: Blockly.ASTNode.Params
        );
...
declare module Blockly {
    ...
    class BasicCursor__Class extends Blockly.Cursor__Class {
         ...
         */
        getNextNode_(
            node: Blockly.ASTNode,
            isValid: { (_0: Blockly.ASTNode): boolean }
        ): Blockly.ASTNode;
...
declare module Blockly {
    ...
    /** Fake class which should be extended to avoid inheriting static properties */
    class ToolboxCategory__Class
        extends Blockly.ToolboxItem__Class
...
declare module Blockly {
    ...
    /** Fake class which should be extended to avoid inheriting static properties */
    class CollapsibleToolboxCategory__Class
        extends Blockly.ToolboxCategory__Class
...
declare module Blockly {
        ...
        implements Blockly.IToolboxItem
    {
         ...
         */
        constructor(
            separatorDef: Blockly.utils.toolbox.SeparatorInfo,
            toolbox: Blockly.IToolbox
        );
...
declare module Blockly {
            ...
            Blockly.IToolbox
    {
         ...
         * @protected
         */
        updateCursorDeleteStyle_(addStyle: boolean): void;
         ...
         */
        shouldDeselectItem_(
            oldItem: Blockly.ISelectableToolboxItem,
...
declare module Blockly.utils.aria {
    ...
    function setState(
        element: Element,
        stateName: Blockly.utils.aria.State,
...
declare module Blockly.utils.Coordinate {
     ...
     */
    function equals(
        a: Blockly.utils.Coordinate,
        b: Blockly.utils.Coordinate
    ): boolean;
     ...
     */
    function difference(
        a: Blockly.utils.Coordinate | SVGPoint,
        b: Blockly.utils.Coordinate | SVGPoint
    ): Blockly.utils.Coordinate;
...
declare module Blockly.utils.toolbox {
     ...
     *          }
     */
    interface FlyoutItemInfoArray
        extends Array<Blockly.utils.toolbox.FlyoutItemInfo> {}
     ...
     * @package
     */
    function convertToolboxDefToJson(
        toolboxDef: Blockly.utils.toolbox.ToolboxDefinition
    ): Blockly.utils.toolbox.ToolboxInfo;
     ...
     * @package
     */
    function convertFlyoutDefToJsonArray(
    ...
    function hasCategories(
        toolboxJson: Blockly.utils.toolbox.ToolboxInfo
    ): boolean;
     ...
     * @package
     */
    function isCategoryCollapsible(
        categoryInfo: Blockly.utils.toolbox.CategoryInfo
    ): boolean;
...
declare module Blockly.blockRendering {
    ...
    class ConstantProvider__Class {
        ...
        validatedBlockStyle_(blockStyle: {
            colourPrimary: string;
            colourSecondary: string | any /*undefined*/;
            colourTertiary: string | any /*undefined*/;
            hat: string | any /*undefined*/;
...
declare module Blockly.blockRendering {
    ...
    class Debug__Class {
         ...
         */
        drawSpacerElem(
            elem: Blockly.blockRendering.InRowSpacer,
            rowHeight: number,
            isRtl: boolean
        ): void;
...
declare module Blockly.blockRendering {
    ...
    class Drawer__Class {
        ...
        positionInlineInputConnection_(
            input: Blockly.blockRendering.InlineInput
        ): void;
...
declare module Blockly.blockRendering {
    ...
    class Renderer__Class implements Blockly.IRegistrable {
        ...
        getConnectionPreviewMethod(
            closest: Blockly.RenderedConnection,
...
declare module Blockly.blockRendering {
    ...
    class Connection__Class extends Blockly.blockRendering.Measurable__Class {
        ...
        constructor(
            constants: Blockly.blockRendering.ConstantProvider,
            connectionModel: Blockly.RenderedConnection
        );
    }

    class OutputConnection extends OutputConnection__Class {}
    /** Fake class which should be extended to avoid inheriting static properties */
    class OutputConnection__Class extends Blockly.blockRendering
        .Connection__Class {
        /**
    ...
    /** Fake class which should be extended to avoid inheriting static properties */
    class PreviousConnection__Class extends Blockly.blockRendering
        .Connection__Class {
        /**
    ...
    /** Fake class which should be extended to avoid inheriting static properties */
    class NextConnection__Class extends Blockly.blockRendering
        .Connection__Class {
        /**
...
declare module Blockly.blockRendering {
    ...
    /** Fake class which should be extended to avoid inheriting static properties */
    class InputConnection__Class extends Blockly.blockRendering
        .Connection__Class {
        /**
    ...
    /** Fake class which should be extended to avoid inheriting static properties */
    class InlineInput__Class extends Blockly.blockRendering
    ...
    /** Fake class which should be extended to avoid inheriting static properties */
    class StatementInput__Class extends Blockly.blockRendering
        .InputConnection__Class {
        /**
    ...
    /** Fake class which should be extended to avoid inheriting static properties */
    class ExternalValueInput__Class extends Blockly.blockRendering
        .InputConnection__Class {
        /**
...
declare module Blockly.blockRendering.Types {
     ...
     */
    function isSpacer(
        elem: Blockly.blockRendering.Measurable | Blockly.blockRendering.Row
    ): number;
     ...
     * @package
     */
    function isPreviousOrNextConnection(
        elem: Blockly.blockRendering.Measurable
    ): number;
