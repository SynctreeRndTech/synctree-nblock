...
declare module Blockly.Block {
  ...
  /**
   * mutator block item count.
   * @const {string}
   */
  var itemCount_: number;
}
...
declare module Blockly {
  ...
  class BlockDragger__Class implements Blockly.IBlockDragger {
     ...
     * @protected
     */
    getNewLocationAfterDrag_(currentDragDeltaXY: Blockly.utils.Coordinate): {
...
declare module Blockly.blockRendering {
  ...
  class Drawer__Class {
     ...
     */
    layoutField_(
      fieldInfo: Blockly.blockRendering.Icon | Blockly.blockRendering.Field
    ): void;
