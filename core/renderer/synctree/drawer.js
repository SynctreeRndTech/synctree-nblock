...
Blockly.synctree.Drawer = function (block, info) {
    Blockly.synctree.Drawer.superClass_.constructor.call(this, block, info);
};
Blockly.utils.object.inherits(
    Blockly.synctree.Drawer,
 ...
 * @override
 */
Blockly.synctree.Drawer.prototype.draw = function () {
    var pathObject =
        /** @type {!Blockly.synctree.PathObject} */ this.block_.pathObject;
 ...
 * @override
 */
Blockly.synctree.Drawer.prototype.drawOutline_ = function () {
    if (
        ...
        Blockly.synctree.Drawer.superClass_.drawOutline_.call(this);
    }
};
 ...
 * @override
 */
Blockly.synctree.Drawer.prototype.drawLeft_ = function () {
    if (
        this.info_.outputConnection &&
        this.info_.outputConnection.isDynamicShape
    ) {
        ...
        Blockly.synctree.Drawer.superClass_.drawLeft_.call(this);
    }
};
 ...
 */
/*
Blockly.synctree.Drawer.prototype.drawRightSideRow_ = function (row) {
    if (row.height <= 0) {
        return;
    }
    ...
    // console.log('synctree', this.outlinePath_);
};
*/
 ...
 * @protected
 */
Blockly.synctree.Drawer.prototype.drawRightDynamicConnection_ = function () {
 ...
 * @protected
 */
Blockly.synctree.Drawer.prototype.drawLeftDynamicConnection_ = function () {
 ...
 * @protected
 */
Blockly.synctree.Drawer.prototype.drawFlatTop_ = function () {
 ...
 * @protected
 */
Blockly.synctree.Drawer.prototype.drawFlatBottom_ = function () {
 ...
 */
/*
Blockly.synctree.Drawer.prototype.drawInlineInput_ = function (input) {
...
/** bottom notch inside inner
 * @override
 */
Blockly.synctree.Drawer.prototype.drawStatementInput_ = function (row) {
